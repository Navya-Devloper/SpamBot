...
RIZ_PIC = ALIVE_PIC if ALIVE_PIC else "https://te.legra.ph/file/0cb0a04edd1d3eea89108.jpg"
  

rizoel = "✯ 𝗦𝘂𝘀𝗵𝗶𝗟𝗫𝗦𝗽𝗮𝗺 𝗛𝗲𝗿𝗲 ✯\n\n"
rizoel += f"═══════════════════\n"
rizoel += f"• **ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `3.9.6`\n"
rizoel += f"• **ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `{version.__version__}`\n"
rizoel += f"• **sᴜsʜɪʟXsᴘᴀᴍ ᴠᴇʀsɪᴏɴ**  : `{rizoelversion}`\n"
rizoel += f"═══════════════════\n\n"   
...
async def alive(event):
  if event.sender_id in SUDO_USERS:
     await event.client.send_file(event.chat_id,
                                  ...
                                  buttons=[
        [
        Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/TheiSOUL"),
        Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/iSOULSPAM")
        ],
        [
        Button.url("• ʀᴇᴘᴏ •", "https://t.me/TheiSOUL")
        ]
        ]
        )
...
async def restart(e):
    if e.sender_id in SUDO_USERS:
        text = "**Restarting Your Sushil X Spam**.. Please Wait Until It Starts Again"
