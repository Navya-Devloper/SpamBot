from SushilXSpam import Riz, Riz2, Riz3, Riz4, Riz5, Riz6, Riz7, Riz8, Riz9, Riz10, SUDO_USERS
from telethon import events, Button
from telethon.tl.custom import button
from time import time
from datetime import datetime
from SushilXSpam import CMD_HNDLR as hl
    
HELP_PIC = "https://te.legra.ph/file/0cb0a04edd1d3eea89108.jpg"
...
async def helpback(event):
   if event.query.user_id in SUDO_USERS:    
      await event.edit(
        ...
        Alert = (
                "Noob !! Make Your Own Sushil X Spam Bots !!"
            )
